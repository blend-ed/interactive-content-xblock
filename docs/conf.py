...
"""
interactive-html-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'interactive-html-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/blend-ed/interactive-html-xblock",
...
#
# html_title = 'interactive-html-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Interactive HTML XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'interactive_html_xblock'),
                os.path.join(root_path, 'interactive_html_xblock/migrations')])
