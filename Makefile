...
REPO_NAME := interactive-html-xblock
PACKAGE_NAME := interactive_html_xblock
...
compile_translations: ## compile translation files, outputting .mo files for each supported language
	...
	python manage.py compilejsi18n --namespace InteractiveHtmlXblockI18n --output $(JS_TARGET)
